<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Trial.aspx.cs" Inherits="MajorProject.Trial" %>
        ...
        <div class="container-fluid">
         <h2 class="d-block p-3 bg-dark text-white text-start">
                          <asp:DropDownList ID="DropDownList2" runat="server" style= "text-align: left" class="btn btn-dark dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" AutoPostBack="True" Font-Size="Large" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged">
                               ...
                               <asp:ListItem Value="1">Employee Page</asp:ListItem>
            ...
            <div class="col" style="background-color: #D3D3D3; color: black; text-align: center; height:900px">
                  
                       <div class="alert alert-primary" style="text-align:center; margin-left:0px; margin-right:0px;"  role="alert"> Employee needs to upload an image from the location to be punched in!</div>
								 
                                    <div class="container  border border border-4"  style=" background-color: white; color: black; text-align: center; height:775px; width:1400px" >
                                    <div class="row">
                                           <div class="col-md-8">
                                               <div class="text-start my-4">
                                               <asp:Label ID="Label7" runat="server" Text="Employee ID:" Font-Bold="True"></asp:Label>&nbsp;
                                                   <asp:Label ID="Label8" runat="server" Font-Bold="True" ForeColor="#0066FF"></asp:Label><br /><br />
                                                   <asp:Label ID="Label9" runat="server" Text="Employee Name:" Font-Bold="True"></asp:Label>&nbsp;
                                                   <asp:Label ID="Label10" runat="server" Font-Bold="True" ForeColor="#0066FF"></asp:Label><br /><br />
                                                   <asp:Label ID="Label3" runat="server" Text="Branch: " Font-Bold="True"> </asp:Label>&nbsp;
                                                <asp:TextBox ID="TextBox1" runat="server"   placeholder="Employee Branch" ReadOnly="True"></asp:TextBox>
                                           ...
                                           <asp:Label ID="Label2" runat="server" Text="Map Preview" Font-Bold="True"></asp:Label>
                                            ...
                                            <div class="col-md-4">
                                                <br />
                                                <div class="text-center"><asp:Image ID="Image1" runat="server" Height="200px" ImageUrl="~/pics/uploadicon.jpg" Width="200px" BorderStyle="Ridge" BorderWidth="2px" />
                                               </div>
                                            <div class="text-start">
                                                 <br /><br />

                                                <asp:Label ID="Label1" runat="server" Text="Upload Image" Font-Bold="True"></asp:Label><br /><br />
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <br />
                                                     <asp:Button ID="Upload" runat="server" Text="Upload Image" class="btn btn-dark" OnClick="Upload_Click" />
                                                </div>
                                                 <br />
                                                <asp:Label ID="Label5" runat="server" Text="Upload Image" Font-Bold="True"></asp:Label>
                                                <br />
                                                <asp:Label ID="Latitude" runat="server"  Font-Bold="True"></asp:Label>&nbsp;<asp:Label ID="Longitude" runat="server"  Font-Bold="True"></asp:Label>

                                                <asp:Label ID="DateandTime" runat="server"  Font-Bold="True"></asp:Label><br />
